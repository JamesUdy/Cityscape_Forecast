...
const SearchCity = ({handleSearch, setLocationData}: InputProps) => {
  return (
    <>
      <form className='bg-white shadow-xl ease-in duration-200 hover:ring-2 hover:ring-[#adb5bd86] shadow-[#adb5bd] hover:shadow-[#001f3f6b] flex w-2/5 justify-between px-2 py-2 gap-2 mx-auto rounded-lg group'>
